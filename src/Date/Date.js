const data = [
    ...
    {
        question: 'Can you explain what Function.call and Function.apply do? What\'s the notable difference between the two?',
        url: '',
        status: 0
    },
    {
    ...
    {
        question: 'Explain the difference between mutable and immutable objects. What is an example of an immutable object in JavaScript? What are the pros and cons of immutability? How can you achieve immutability in your own code?',
        url: '',
        status: 0
    },
    {
